...
![T2·B normateca](../Diagramas/T02/T2-B-normateca.svg)

![T2·C ciclo de mejora regulatoria](../Diagramas/T02/T2-C-mejora-regulatoria.svg)
...
> Retro-ajuste del **2026-09-23** (énfasis 1 del sprint). Una fila por paso del §7. Rutas reales en `Docs/Comun/` o `[clave]` + página del §2; sistemas externos nombrados con su campo (**Gaceta**, **SAIR**, **SIPAMR**, **RETYS**). Huecos → `V-##`. Los borradores y oficios internos sin plantilla los cubre **V-05** (flujo interno no documentado).

| Paso | Documento / dato de entrada | Datos que se capturan / procesan | Documento de salida |
|---|---|---|---|
| **A1** — detección de la necesidad | Reforma legal superior (p. ej. Código para la Biodiversidad, arts. 3.17–3.19 — citado en `Docs/Comun/Sitio web/funciones.html`; PDF no capturado → **V-10**); vigencia anual de RO y trámites (`Docs/Comun/Manual Jurídico/Normateca/AGENDA_REGULATORIA_2025.pdf` campos 13/15); necesidad detectada por la unidad | Motivo (reforma superior, cambio de estructura, vencimiento de vigencia), materia, unidad que propone | Iniciativa / nota interna de necesidad (sin formato capturado → **V-05**) |
| **A2** — elaboración del proyecto | Versiones previas del ordenamiento (`Docs/Comun/Manual Jurídico/may281.pdf` [MGO12], `rglvig245.pdf` [RI], `dic161d.pdf` [MGO25]); créditos de elaboración del precedente 2025 ([MGO25] p. 39: DAFGD + UIPPE) | Texto del proyecto; **créditos de elaboración** (quién lo redacta) | **Proyecto de ordenamiento** (borrador con créditos; sin plantilla → **V-05**) |
| **A3** — revisión jurídica (UJIGEV) | Proyecto de A2; funciones UJIGEV [MGO25] pp. 15–16 | Observaciones jurídicas; visto bueno para el cauce institucional *(paso inferido → V-05)* | Revisión / **v.Bo. jurídico de UJIGEV** (sin formato → **V-05**) |
| **A4** — presentación al Consejo Directivo | Proyecto con v.Bo. (A3); calendario de sesiones del Consejo [RI art. 9 fr. IV, `Docs/Comun/Manual Jurídico/rglvig245.pdf`] | Fecha de sesión (ordinaria/extraordinaria), orden del día | Expediente presentado al **Consejo Directivo** + citación a sesión (integración vigente → **V-04**) |
| **A5** — acuerdo del Consejo | Expediente de A4; [RI art. 9 fr. IV] | **Acuerdo numerado** (p. ej. PBE/07-2025/003SE de la 7ª Sesión Extraordinaria, 01-dic-2025 [MGO25] p. 38) | **Acuerdo numerado del Consejo Directivo** asentado en el **acta de sesión** |
| **A6** — remisión a Oficialía Mayor | Acuerdo de A5 + expediente completo con **validaciones de titularidades** ([MGO25] p. 37: 10 firmas) | Folio y fecha del oficio de remisión | **Oficio de remisión a la Oficialía Mayor (DGI)** (sin plantilla → **V-05**) |
| **A7** — dictamen de la DGI | Expediente de A6; **lineamientos técnicos estatales** de manuales de organización (no están en el repo → **V-09**) | Resultado del dictamen (procedente/no), folio del oficio (p. ej. 23400006L-0979/2025, 21-nov-2025) | **Oficio de dictaminación de la DGI** [MGO25] p. 39 (firmantes: Campuzano Ramírez, García Munguía, Martínez Maximino, Osorio Mendoza) |
| **A8** — publicación en la Gaceta | Ordenamiento dictaminado [BR-2] | Fecha, tomo y número de la **Gaceta del Gobierno** (p. ej. MGO 2025: 16-dic-2025, Tomo CCXX No. 112) | **Gaceta del Gobierno** con el ordenamiento (medio oficial, no archivo local [GACETA]) → **entra en vigor** |
| **A9** — hoja de actualización y difusión | Gaceta de A8 [MGO25] pp. 15–16 y p. 38 | Texto "deja sin efectos al publicado el…"; fecha de vigencia; unidades a notificar | **Hoja de actualización** del MGO + difusión interna del nuevo marco a las unidades |
| **A10** — carga en la Normateca | Ordenamiento publicado (A8–A9) [BR-5] | Entrada en el inventario jerárquico: título, nivel (manual/acuerdo/…), enlace | Disposición publicada en la Normateca (`Docs/Comun/Sitio web/marco_juridico.html`) — mecanismo de carga → **V-06** |
| **B1** — inventario por unidad | Orden jerárquico del [MOR-N] `Docs/Comun/Manual Jurídico/manualDeOperacionNormatecaInterna.pdf` §integración; inventario vigente `Docs/Comun/Sitio web/marco_juridico.html` [MJ-HTML] | Disposiciones aplicables por materia y su versión vigente | Relación de disposiciones por unidad (insumo del inventario; sin formato estandarizado) |
| **B2** — adiciones y sustituciones | Relación de B1; [MOR-N] §operación ("serán reemplazadas conforme sea actualizado el marco") | Acuerdo de adición, sustitución o reemplazo por disposición | Acuerdo de **actualización del inventario** (Comité/UJIGEV; sin plantilla → **V-05**) |
| **B3** — compilación electrónica | Disposiciones actualizadas; [MGO25] pp. 15–16 (UJIGEV coordina la compilación) | Compilación por nivel jerárquico (constitución → leyes → … → acuerdos) | **Normateca Interna compilada** (inventario electrónico) |
| **B4** — bajas y reemplazos | Novedades de la Gaceta (p. ej. Ley de Ingresos 2026 y Presupuesto de Egresos 2026 reemplazan a las de 2025 — visible en [MJ-HTML]) | Estado por disposición: vigente / reemplazada; fecha de reemplazo (**hoy el sitio no la muestra → V-08**) | **Inventario actualizado con bajas** (registro de reemplazo) |
| **B5** — actualización del sitio | Compilación de B3–B4 [BR-5] | Archivos a subir, fecha de actualización de la página | `Docs/Comun/Sitio web/marco_juridico.html` y `mejora-regulatoria.html` actualizados (operador R26: UCSyTI + Agencia Digital; mecanismo de carga → **V-06**) |
| **B6** — difusión interna | Marco actualizado [MOR-N]; [BR-4] ("el personal está obligado a conocer y cumplir") | Fecha y medio de difusión; unidades notificadas | **Aviso de difusión** del marco vigente a las unidades (sin formato capturado; obliga a conocer y cumplir) |
| **C1** — sesiones del Comité Interno de MR | Convocatoria y documentación de sesión; fundamento: arts. 27–28 Ley MR, 23/26/27/29 Reglamento MR y arts. 4 y 7 fr. IV del **Acuerdo creador 2019** (el acuerdo no está en el repo → **V-02**); precedente `Docs/Comun/Manual Jurídico/Normateca/ACTA_1a_Sesion_Ordinaria_Comite_2025.pdf` [ACTA25] | Asistencia, quórum, órdenes del día, resoluciones | **Acta de sesión del Comité** (serie 2018–2026 publicada en `Docs/Comun/Sitio web/mejora-regulatoria.html` [MR-HTML]) |
| **C2** — reporte trimestral de avance | Avances recopilados de cada unidad; Programa Anual `Docs/Comun/Manual Jurídico/Normateca/PMR_2026.pdf` [PMR26] y `Programa_MejoraRegulatoria_2026.pdf`; [ACTA25] orden IV | % de avance por propuesta regulatoria del ejercicio | **Reporte trimestral de avance del Programa Anual** (serie 2018–2025 en [MR-HTML]) |
| **C3** — altas, modificaciones y bajas de trámites | [ACTA25] orden V (baja "Reforestación Social y Urbana"); [AGENDA25] campos 13/15/17 | Trámite dado de alta/baja/modificado; **ID RETYS** (PSAHEM 51, RHF 627, CC 309…) | **Acuerdo del Comité** + actualización en **RETYS** (sistema estatal; campo: ID y ficha del trámite) |
| **C4** — AIR o exención vía SAIR | Proyecto regulatorio de A2; criterios de exención (no crea obligaciones, no restringe derechos, no añade trámites, no modifica definiciones — considerandos de [DICT-LINE]/[DICT-RI]) | Folio **SAIR**, tipo de solicitud (AIR / exención), fundamentos | **Solicitud capturada en SAIR** (plataforma CEMER; registro electrónico sin formato local) |
| **C5** — resolución de CEMER | Solicitud de C4 | Resolución (procedente la exención / AIR), fecha, destinatario (Enlace R23) | **Dictamen/oficio de CEMER** — ejemplares capturados: `Docs/Comun/Manual Jurídico/Normateca/LINEAMIENTOS_Comite_Interno_MejoraRegulatoria.pdf` (01-oct-2019) y `Docs/Comun/Manual Jurídico/Normateca/DICTAMEN_AIR_Reglamento_Interno.pdf` (09-oct-2019) |
| **C6** — SIPAMR y Agenda Regulatoria | [PMR26] (impresión del **Sistema SIPAMR**, periodo 2026); formato CEMER de **19 campos** [AGENDA25] | Los 19 campos de la agenda (ID RETYS = campo 17; vigencias = campos 13/15); propuestas del biannual (7 en 2025-26); DAFO del diagnóstico | **PMR capturado en SIPAMR** (sistema estatal) + **Agenda Regulatoria** en formato CEMER (presentada 23-oct-2025) |
| **C7** — seguimiento y publicación | Acuerdos pendientes [ACTA25] órdenes VI–VIII; productos del ciclo (PMR, agenda, actas, reportes) | Estado de cada acuerdo y asunto general | Productos publicados en `Docs/Comun/Sitio web/mejora-regulatoria.html` [MR-HTML] (PMR, agenda, actas, reportes trimestrales) |
