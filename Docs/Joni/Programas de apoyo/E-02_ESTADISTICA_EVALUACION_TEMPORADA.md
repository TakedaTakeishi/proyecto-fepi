...
| **V-11** | Los **convenios de mejora y actas de cumplimiento** de las evaluaciones 2014–2023: [EVAL-H] los enlaza, pero sus PDF no están capturados (solo la página índice offline) | `Docs/Comun/Sitio web/evaluacion_programas.html` lista la serie; el único PDF del ciclo en el repo es [CONAC23] | Descargar la serie del sitio estatal a `Docs/Comun/` (tarea) | N-09 · B5–B6 |
...
| **B1** — Programa Anual de Evaluación (PAE) | **PAE** emitido por la Subsecretaría de Planeación / DG de Evaluación del Desempeño (estatal; documento no capturado → **V-03**); historial de evaluaciones 2014–2023 en `Docs/Comun/Sitio web/evaluacion_programas.html` [EVAL-H] | Tipo de evaluación asignada al Pp. 03020201 (diseño / procesos / consistencia y resultados / específica de desempeño), plazos y alcance | **PAE del ejercicio** con el Pp. "Desarrollo Forestal" incluido (formato estatal; no en repo → **V-03**) |
