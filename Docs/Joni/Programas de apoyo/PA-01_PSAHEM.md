...
![PA1·A](../Diagramas/PA01/PA1-A-solicitud.svg)

![PA1·B](../Diagramas/PA01/PA1-B-contrato-pago.svg)

![PA1·C](../Diagramas/PA01/PA1-C-verificacion-cierre.svg)
...
| **V-10** | ~~El **listado 2026 de beneficiarios aprobados** (Gaceta/sitio) no fue capturado: solo hay evidencia histórica 2017-18~~ | ✅ **Cerrado 2026-09-23**: capturado del sitio `Docs/Comun/Programas de apoyo/Listado_Beneficiarios_PSAHEM_2026-06_FO-PB-516.pdf` (publicación jun-2026, clave FO-PB-516 confirmada en el sitio) | — | N-10 · A10 |
...
| **V-12** | **Formatos menores sin FO-PB capturado** que la §12 exige como entrada/salida: requerimiento de faltantes, nota de turno de expediente, plantilla de **dictamen jurídico**, minuta/acuerdo de la CVT, visto bueno de UJIGEV, solicitud de pago a fiduciaria, aviso de notificación de pago, bitácora de asistencia técnica, resolución de graduación, informe anual de ejecución | En `Docs/Comun/Programas de apoyo/` solo existen FO-PB-501A/501B/502 y la guía de proyecto técnico; [RO] los nombra sin dar formato | SSA/MIF + inventario de formatos **X-03** (área ISO — cf. V-05) | A3–A5, A7–A8, B2, B4, B6, C1–C2, C8–C9 |
...
- **V-10 cerrada (2026-09-23)**: captura del listado 2026 de beneficiarios PSAHEM (`Listado_Beneficiarios_PSAHEM_2026-06_FO-PB-516.pdf`, jun-2026) + confirmación de la clave **FO-PB-516** (Listado de Personas Beneficiarias) y del **Listado de Incumplidos** vivo (`Listado_Beneficiarios_Incumplidos_2026-07-08.pdf`) — ambos descargados del sitio.
...
> Retro-ajuste del **2026-09-23** (énfasis 1 del sprint). Una fila por paso del §7. Referencias = rutas reales en `Docs/Comun/` o `[clave]` + página del §2; los sistemas externos se nombran con el campo que aportan. Toda celda cuyo documento/dato **no existe en las fuentes** se enlaza a su `V-##`.

| Paso | Documento / dato de entrada | Datos que se capturan / procesan | Documento de salida |
|---|---|---|---|
| **A1** — publicación de RO y convocatoria | Texto normativo aprobado: `Docs/Comun/Programas de apoyo/RO_2026_PagoServiciosAmbientales_Hidrológicos.pdf` [RO] + `Docs/Comun/Programas de apoyo/CONVOCATORIA_2026_Programas_Apoyo.pdf` [CONV] pp. 9–11 (calendarios) | Fecha de publicación, Tomo/No. de Gaceta, vigencia de la convocatoria (día siguiente al 27-ene-2026 → 27-mar-2026), URL de descarga en el sitio | RO + Convocatoria publicadas en **Gaceta** (27-ene-2026, Tomo CCXXI No. 15) y en el sitio de PROBOSQUE (los dos PDF anteriores, ya capturados) |
| **A2** — integración de la solicitud | `Docs/Comun/Programas de apoyo/FORMATO_FO-PB-501A_SolicitudUnica_2026.docx` [501A] + `Docs/Comun/Programas de apoyo/FORMATO_FO-PB-502_RegInfo_Solicitante_Beneficiario_2026.docx` [502]; identificación oficial y **CURP** (dato de la persona); documento de propiedad/posesión (PHINA/ADDATE, escritura, o constancia del Comisariado/Ayuntamiento con plano) [RO pp. 10–12 §8.1.1.2]; **actas RAN** — sistema **RAN** (Registro Agrario Nacional), campo: acta inscrita o en trámite | Datos de la persona solicitante y de la **2ª persona beneficiaria**; tipo de persona (física / jurídico colectiva / núcleo agrario); folios de refrendo 2023–2025; superficie por concepto; predio, municipio y **DRF que corresponde** (tabla de [CONV] pp. 8–9) | Paquete de solicitud (sin folio aún): **FO-PB-501A** + **FO-PB-502** + anexos de identificación, titulación y RAN |
| **A3** — recepción en DRF, folio y comprobante | Paquete de A2; checklist 1–11 y declaratoria de no litigio (reverso de [501A] hoja 2); regla de 5 días hábiles para faltantes [CONV p. 9] | **Folio de solicitud** (se genera al completar requisitos), fecha/hora de recepción, resultado del cotejo de requisitos, lista de faltantes | **Comprobante de recepción** (hoja 2 de FO-PB-501A: folio de expediente, firma y sello de la DRF) + folio de solicitud; requerimiento de faltantes → **V-12** |
| **A4** — turno del expediente | Paquete con folio (A3) | Fecha de turno, área ejecutora (área responsable) destino; control de "no se reciben expedientes sueltos" [RO 8.1.1.2·II] | Expediente turnado al área ejecutora (nota/acuse de turno interno, sin formato FO-PB → **V-12**) |
| **A5** — levantamiento de la poligonal | Ubicación del predio declarado en A2; aparato de levantamiento **GPS/SIG** (campos: coordenadas de vértices, superficie) [RO p. 19 §10.1·I]; coberturas por formación observadas en campo [RO p. 11 §8.1.1.2·VI] | **Poligonal** (coordenadas, superficie), cobertura arbolada por formación (templado / tropical caducifolio / semiárido) | Plano/croquis con al menos una coordenada, firmado, como anexo del expediente (sin formato FO-PB capturado → **V-12**; el dato geoespacial se indexa por folio de expediente) |
| **A6** — integración, validación y digitalización | Expediente con poligonal; para refrendos: solicitud + CURP + documentación legal actualizada "mencionando el **folio del expediente**" [501A hoja 2]; **archivo de expedientes previos** (físico/digital, campo: folio de expediente) | Validación de integración, marca de refrendo ≤3 años y folios de ejercicios anteriores; imágenes del expediente | **Expediente digitalizado** identificado con **folio de expediente** (PDF por expediente; sin plantilla FO-PB) |
| **A7** — dictámenes jurídico y técnico | Expediente digitalizado (A6); actas RAN; declaratoria de no litigio ([501A] hoja 2); [RO] criterios y **tabla de puntos** pp. 8–9 §8.1.1.1 | Dictamen jurídico: propiedad/posesión, RAN, representación, no litigio. Dictamen técnico: **tabla de puntos** (cobertura mínima, no doble PSA, tala clandestina, plagas) | **Dictamen jurídico** (plantilla → **V-12**) y **Dictamen Técnico del SGC** (formato con tabla de puntos → **V-05**) + listado preliminar de factibles/no factibles |
| **A8** — análisis de la CVT | Dictámenes de A7 + aviso de ingreso de solicitudes [RO p. 19 §10.1·V] | Clasificación por expediente: factible / no factible de pago | Dictamen o minuta de la **CVT** (sin formato capturado → **V-12**; composición de la CVT → **V-02**) |
| **A9** — sesión del Comité Técnico | Listados de A8 + dictámenes; convocatoria a sesión con **citación 72 h** firmada por Presidencia [RIC arts. 25–26] | Acuerdo por expediente: aprobado / no aprobado (rechazo **fundado y motivado**) | **Acta de sesión del Comité Técnico** con los listados aprobados y citación a sesión (el acta no es pública → **V-08**) |
| **A10** — publicación y notificación de resultados | Acta de A9 | Listado de aprobados; datos de contacto de no aprobados y motivo de rechazo | **Publicación de resultados**: sitio de PROBOSQUE + **Gaceta** (PSAHEM) — serie histórica en `Docs/Comun/Sitio web/historico.html`; **listado 2026 capturado: `Docs/Comun/Programas de apoyo/Listado_Beneficiarios_PSAHEM_2026-06_FO-PB-516.pdf` (FO-PB-516)**; notificación a no aprobados (sin formato → **V-12**) |
| **B1** — elaboración del contrato | Expedientes aprobados (acta A9); montos/ha 2026 [RO §7.1.1] | Datos del contrato: partes, vigencia, monto/ha, superficie | Proyecto de **Contrato de Adhesión** o **Convenio de Concertación** (+ adendum) — plantilla no existe en el repo → **V-04** |
| **B2** — validación jurídica del contrato | Proyecto de B1 [RO p. 20 §10.1·VII] | Revisión de fundamentación legal; observaciones y visto bueno | Contrato/adendum con **vo.Bo. de UJIGEV** (sin formato de validación → **V-12**) |
| **B3** — firma del contrato | Contrato validado; identificación de la persona beneficiaria; sello del núcleo agrario (en su caso) | Firma y fecha (10 días hábiles tras resultados; reasignados hasta último día hábil de septiembre) | **Contrato firmado** (ejemplar del expediente y de la persona beneficiaria) |
| **B4** — solicitud del pago a la fiduciaria | Contrato firmado; solicitud del área operativa; ruta formal vía **Secretaría Técnica del Comité** [RO p. 20 §10.1·X] | Monto de la 1ª ministración (70% o 100%), cuenta destino, folio de la solicitud de pago | **Solicitud de pago a la fiduciaria** (5 días hábiles; sin formato FO-PB → **V-12**) |
| **B5** — dispersión de la 1ª ministración | Solicitud de B4; **Aportaciones de Mejoras 3.5%** — sistema de la **Secretaría de Finanzas** (campo: fecha y monto de la transferencia al F/663; flujo real no documentado → **V-11**) | Fecha y monto de dispersión (70% o 100%) desde la cuenta F/663 | **Comprobante de depósito/transferencia** de la fiduciaria (fiduciaria no identificada → **V-01**) |
| **B6** — notificación del pago | Comprobante de B5 [RO p. 20 §10.1·X] | Fecha y medio de notificación (llamada, medio electrónico o visita); prioridad a concurrentes CONAFOR | **Aviso de notificación de pago** a la persona beneficiaria (llamada/correo/visita; sin formato → **V-12**) |
| **C1** — acompañamiento técnico | Contrato con las actividades comprometidas [RO §7.1.2 y §8.1.10] | Visitas de acompañamiento, recomendaciones técnicas, capacitación impartida | **Bitácora de asistencia técnica** por predio (sin formato capturado → **V-12**) |
| **C2** — ejecución de los cuidados | Contrato (obligaciones de protección/conservación) | Avance de actividades en el predio durante la vigencia | Evidencia de ejecución (reportes parciales si los hay — sin formato FO-PB) |
| **C3** — verificación en campo | Contrato + predio; [RO p. 20 §10.1·XI y p. 7 §7.2] | Resultado por predio (cumple / no cumple acciones del contrato); firmas de la persona beneficiaria y del técnico (± asesor CONAFOR en concurrentes) | **Minuta de verificación en campo** firmada → al área responsable con copia a R31 (formato no capturado → **V-06**) |
| **C4** — informe final | Evidencias de C2 + minuta de C3 [RO §7.2] | Resumen de actividades realizadas en la vigencia | **Informe final de actividades** de la persona beneficiaria (formato no capturado → **V-06**) |
| **C5** — solicitud de la 2ª ministración | Informe final + minuta (C3–C4); control por beneficiario de ministraciones 70/30 | Solicitud del 30% restante o, en su defecto, solicitud de cancelación [RO p. 20 §10.1·XII] | **Solicitud de pago** de la 2ª ministración (mismo flujo B4; sin formato → **V-12**) o solicitud de cancelación |
| **C6** — listado de incumplidos | Resultados de verificación; solicitudes de exclusión con prueba de cumplimiento [RO p. 20 §10.1·XV y p. 17 §8.1.9.3·VI] | Causales de incumplimiento por expediente; resolución de exclusiones | **Listado de beneficiarios incumplidos** (documento de UJIGEV, sin FO-PB) |
| **C7** — reintegros y reasignaciones | Listado de C6; pruebas de devolución; [RO p. 17 §8.1.9.3 y p. 20 §10.1·XV] | Montos a reintegrar, cuenta del fideicomiso, predios factibles para reasignación | **Acuerdo del Comité (acta)** de reintegro/reasignación + **comprobante de reintegro** a la cuenta F/663 (detalle en **MF-13**) |
| **C8** — graduación o refrendo | Expediente completo (visita de campo + evaluación documental) [RO §8.2 p. 18] | Dictamen de cumplimiento: graduado / refrenda | **Resolución de graduación** (sin formato capturado → **V-12**) o **solicitud de refrendo** = FO-PB-501A con folios de refrendo 2023–25 (hoja 1) |
| **C9** — informe anual de ejecución | Registros del ejercicio: actas, contratos, comprobantes de pago, minutas, informes [RO p. 20 §16.1] | Cifras del ejercicio: beneficiarios, superficie, montos ministrados/reintegrados | **Informe anual de ejecución** a la Instancia Normativa (→ insumo de **E-02**; sin formato FO-PB → **V-12**) |
